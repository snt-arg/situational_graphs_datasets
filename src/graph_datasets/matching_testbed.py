...
#load dataset 
dataset_generator.deserialize_and_transform_to_GWraph()
...
for i in range(5):
    ...
    print(extended_list[i].get_attributes_of_all_nodes())
    print(extended_list[i].get_attributes_of_all_edges())
...
# # serialize dataset
# dataset_generator.serialize_dataset(digraphs=True)
...
# gv.visualize_nxgraph_pair(a_graphs_list[0], s_graphs_list[0], "serial", visualize_alone=True)


# # deserialize dataset
# dataset_generator.deserialize_dataset(digraphs=True)
# a_graphs_list = dataset_generator.graphs["original"]
# s_graphs_list = dataset_generator.graphs["noise"]
# extended_list = dataset_generator.graphs["extended"]
...
# gv.visualize_nxgraph_pair(a_graphs_list[0], s_graphs_list[0], "imported", visualize_alone=True, g1digraph=True, g2digraph=True)

# for i in range(5):
#     gv.visualize_nxgraph_pair(a_graphs_list[i], s_graphs_list[i], f"orginal_noise{i}", visualize_alone=True, g1digraph=True, g2digraph=True)
